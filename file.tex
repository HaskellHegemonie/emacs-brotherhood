...
\usepackage{hyperref}
\usepackage{xcolor}
\definecolor{ArgentinianBlue}{rgb}{0.424, 0.706, 0.933}
\colorlet{shadecolor}{ArgentinianBlue!15!white}
\usepackage{tikz-cd}
...
\usetikzlibrary{shadows}							% Siehe SEM-ReadMe.pdf für Erläuterungen
%% -- Eigene Definitionen
%% --
